...
public class GameManager : MonoBehaviour {
    ...
    [Header("Hammers")]
    [SerializeField] private GameObject leftHammer;
    [SerializeField] private GameObject rightHammer;
    ...
    public void StartGame() {
        ...
        leftHammer.SetActive(true);
        leftHammer.GetComponent<Hammer>().ResetToStart();
        rightHammer.SetActive(true);
        rightHammer.GetComponent<Hammer>().ResetToStart();
